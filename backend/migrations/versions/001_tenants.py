...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('schema_name', sa.String(), nullable=False, unique=True),
        sa.Column('is_active', sa.Boolean(), server_default='true', nullable=False),
        sa.Column('owner_email', sa.String(), nullable=True, unique=True),
        sa.Column('subscription_tier', postgresql.ENUM('starter', 'pro', 'business', 'enterprise', name='subscription_tier', create_type=False), nullable=True),
        sa.Column('subscription_status', postgresql.ENUM('trial', 'active', 'suspended', 'cancelled', 'expired', name='subscription_status', create_type=False), nullable=True),
